...
export default async function Page({ params }: IPage) {
  ...
  if (!response.length) {
    return (
      <section className="min-h-[88dvh] w-full justify-center items-center flex">
        <p>Maaf, belum ada artikel untuk saat ini...</p>
      </section>
    );
  }
  return (
    <section className="flex h-auto min-h-[88dvh] w-full items-center justify-center gap-3 max-sm:my-10 max-sm:flex-col">
